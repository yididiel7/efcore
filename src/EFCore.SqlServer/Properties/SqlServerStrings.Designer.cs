...
namespace Microsoft.EntityFrameworkCore.SqlServer.Internal
{
    ...
    public static class SqlServerStrings
    {
        ...
        /// <summary>
        ///     Couldn't create a temporal query root for the entity type: '{entityType}'.
        /// </summary>
        public static string TemporalFailedToCreateQueryRoot(object? entityType)
            => string.Format(
                GetString("TemporalFailedToCreateQueryRoot", nameof(entityType)),
                entityType);
