...
namespace Microsoft.EntityFrameworkCore.SqlServer.Metadata.Internal
{
    ...
    public static class SqlServerAnnotationNames
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public const string IsTemporalPeriodStartColumn = Prefix + "IsTemporalPeriodStartColumn";
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public const string IsTemporalPeriodEndColumn = Prefix + "IsTemporalPeriodEndColumn";
